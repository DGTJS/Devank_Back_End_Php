...
<?php
// Supondo que $advertisement->start_date e $advertisement->end_date sejam strings no formato 'Y-m-d'
...
<div class="content container-fluid">
    ...
    <div class="d-flex gap-1"> <a>
                     <p class="d-flex justify-content-between gap-2 align-items-center mb-0">
                                ...
                                <span class="font-semibold text-success" >Pago</span>
                                @else
                                <span class="font-semibold"><a class="btn btn-success" href="https://buy.stripe.com/test_00gbMzaqf2PMbtKcMM">Pagar anúncio</a></span>
...
<!--    <span class="font-medium text-title">({{ $days }} {{ translate('days') }})-->
<!--    </span>-->
<!--</p>-->
...
<hr>
                        <div class="d-flex flex-column gap-2 gap-lg-3 ">
                            ...
                            <p class="d-flex gap-2 justify-content-between align-items-center mb-0">
    <span>Total: </span>
    <span class="font-semibold text-title">R$ {{ number_format($totalCost, 2, ',', '.') }}</span>
</p>
                            ...
                            <p class="d-flex gap-2 justify-content-between align-items-center mb-0">
                                ...
                                <span class="font-medium text-title">{{ \App\CentralLogics\Helpers::date_format($advertisement->start_date).' - ' .\App\CentralLogics\Helpers::date_format($advertisement->end_date) }}</span>
                                   ...
                                   <p class="d-flex gap-2 justify-content-between align-items-center mb-0">
                            <span>Diária<span class="mx-1">:</span></span>
                            <span class="font-medium text-title">({{ $days }} {{ translate('days') }})
                            </span>
                        </p>
